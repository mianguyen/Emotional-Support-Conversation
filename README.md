...
Sorry. We wrongly adopted sentence-level ppl (perplexity) to calculate the ppl of generateion result on test set, which should have been corpus-level. Commonly the result of sentence-level ppl is lower than corpus-level. Hense, here we update the new ppl result:
